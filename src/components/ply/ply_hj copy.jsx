...
class Obj extends Component {
  constructor(props) {
    ...
    console.log("Value: " + props.op_num +", "+props.is_vertex+", " +props.is_wire+", "+props.controls_type+", "+props.rotate_type+", "+props.path);
  }
  ...
  componentDidMount() {
    ...
    this.camera = new THREE.OrthographicCamera(width / - 100, width / 100, height / 100, height / - 100, 1, 1000 );
